        ...
        <div className="container text-center text-bg-light  border ">
          <div className="row">
            <div className="col">
              <p className="p-3">
                <b>Order date</b>
                <br />9 January 2024 - 09:21
              </p>
            </div>
            <div className="col">
              <p className="p-3">
                <b>Order Summary</b>
                <br />1 Delivery, 1 Product
              </p>
            </div>
            <div className="col">
              <p className="p-3">
            ...
            <div className="col ">
              <p className="p-3">
                <span className="text-success me-2 fs-5">
                  <GoCheck className="fs-2" /> Was delivered
                </span>
                <br />
            ...
            <div className="col ">
              <p className="p-3 ">
                <span className="text-warning me-2 fs-5">
                  <TiArrowBack className="fs-2" /> Returned
                </span>
                <br />
                <b>
                  Refund Amount: 3950$ <RiVisaLine className="fs-2" /> ****8888{" "}
                </b>
              </p>
            </div>
            <div className="col">
            ...
            <div className="col ">
              <p className="p-3">
                <span className="text-danger me-2 fs-5">
                  <GrFormClose className="fs-2" /> It is cancelled
                </span>
                <br />
          ...
          <div className="row">
            <div className="col ">
              <p className="p-3 ">
                ...
                <br />
                <b>
                  Refund Amount: 765$ <RiVisaLine className="fs-2" /> ****8888{" "}
                </b>
              </p>
            </div>
            <div className="col">
